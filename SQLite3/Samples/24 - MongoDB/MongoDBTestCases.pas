...
type
  ...
  TSQLCENS_PROG = class(TSQLRecord)
  protected
    //fPRGRUN: Int64;
    fPRGPAR: Int64;
    fPRGORD: Int64;
    ...
    fRECTM1: RawUTF8;
  published
    /// match CENS_PROG.PRGRUN [int 0 19 0] *
    //property PRGRUN: Int64 read fPRGRUN write fPRGRUN;
    /// match CENS_PROG.PRGPAR [int 0 19 0]
    property PRGPAR: Int64 read fPRGPAR write fPRGPAR;
    /// match CENS_PROG.PRGORD [int 0 10 0]
    property PRGORD: Int64 read fPRGORD write fPRGORD;
    /// match CENS_PROG.PRGCDE [nvarchar 60 0 0]
    property PRGCDE: RawUTF8 index 60 read fPRGCDE write fPRGCDE;
    /// match CENS_PROG.PRGABB [nvarchar 60 0 0]
    property PRGABB: RawUTF8 index 60 read fPRGABB write fPRGABB;
    /// match CENS_PROG.PRGNAM [nvarchar 255 0 0]
    property PRGNAM: RawUTF8 index 255 read fPRGNAM write fPRGNAM;
    /// match CENS_PROG.PRGTIT [nvarchar 255 0 0]
    property PRGTIT: RawUTF8 index 255 read fPRGTIT write fPRGTIT;
    /// match CENS_PROG.PRGAPP [nvarchar 255 0 0]
    property PRGAPP: RawUTF8 index 255 read fPRGAPP write fPRGAPP;
    /// match CENS_PROG.PRGPKG [nvarchar 255 0 0]
    property PRGPKG: RawUTF8 index 255 read fPRGPKG write fPRGPKG;
    /// match CENS_PROG.PRGAPT [nvarchar 255 0 0]
    property PRGAPT: RawUTF8 index 255 read fPRGAPT write fPRGAPT;
    /// match CENS_PROG.PRGPA1 [nvarchar 255 0 0]
    property PRGPA1: RawUTF8 index 255 read fPRGPA1 write fPRGPA1;
    /// match CENS_PROG.PRGFUL [int 0 10 0]
    property PRGFUL: Int64 read fPRGFUL write fPRGFUL;
    /// match CENS_PROG.RECACT [nvarchar 10 0 0]
    property RECACT: RawUTF8 index 10 read fRECACT write fRECACT;
    /// match CENS_PROG.CMPCDE [nvarchar 5 0 0]
    property CMPCDE: RawUTF8 index 5 read fCMPCDE write fCMPCDE;
    /// match CENS_PROG.CMPBRN [nvarchar 5 0 0]
    property CMPBRN: RawUTF8 index 5 read fCMPBRN write fCMPBRN;
    /// match CENS_PROG.CMPDEP [nvarchar 5 0 0]
    property CMPDEP: RawUTF8 index 5 read fCMPDEP write fCMPDEP;
    /// match CENS_PROG.CMPSEC [nvarchar 5 0 0]
    property CMPSEC: RawUTF8 index 5 read fCMPSEC write fCMPSEC;
    /// match CENS_PROG.ENTUID [int 0 19 0]
    property ENTUID: Int64 read fENTUID write fENTUID;
    /// match CENS_PROG.ENTUSR [nvarchar 60 0 0]
    property ENTUSR: RawUTF8 index 60 read fENTUSR write fENTUSR;
    /// match CENS_PROG.ENTDTE [date]
    property ENTDTE: TDateTime read fENTDTE write fENTDTE;
    /// match CENS_PROG.ENTTIM [date]
    property ENTTIM: TDateTime read fENTTIM write fENTTIM;
    /// match CENS_PROG.ENTWKS [nvarchar 100 0 0]
    property ENTWKS: RawUTF8 index 100 read fENTWKS write fENTWKS;
    /// match CENS_PROG.MODUID [int 0 19 0]
    property MODUID: Int64 read fMODUID write fMODUID;
    /// match CENS_PROG.MODUSR [nvarchar 60 0 0]
    property MODUSR: RawUTF8 index 60 read fMODUSR write fMODUSR;
    /// match CENS_PROG.MODDTE [date]
    property MODDTE: TDateTime read fMODDTE write fMODDTE;
    /// match CENS_PROG.MODTIM [date]
    property MODTIM: TDateTime read fMODTIM write fMODTIM;
    /// match CENS_PROG.MODWKS [nvarchar 100 0 0]
    property MODWKS: RawUTF8 index 100 read fMODWKS write fMODWKS;
    /// match CENS_PROG.RECSTS [nvarchar 10 0 0]
    property RECSTS: RawUTF8 index 10 read fRECSTS write fRECSTS;
    /// match CENS_PROG.RECSEQ [int 0 10 0]
    property RECSEQ: Int64 read fRECSEQ write fRECSEQ;
    /// match CENS_PROG.RECFL1 [nvarchar 3 0 0]
    property RECFL1: RawUTF8 index 3 read fRECFL1 write fRECFL1;
    /// match CENS_PROG.RECFL2 [nvarchar 3 0 0]
    property RECFL2: RawUTF8 index 3 read fRECFL2 write fRECFL2;
    /// match CENS_PROG.RECFL3 [nvarchar 3 0 0]
    property RECFL3: RawUTF8 index 3 read fRECFL3 write fRECFL3;
    /// match CENS_PROG.RECFL4 [nvarchar 3 0 0]
    property RECFL4: RawUTF8 index 3 read fRECFL4 write fRECFL4;
    /// match CENS_PROG.RECFL5 [nvarchar 3 0 0]
    property RECFL5: RawUTF8 index 3 read fRECFL5 write fRECFL5;
    /// match CENS_PROG.PRGGRP [nvarchar 60 0 0]
    property PRGGRP: RawUTF8 index 60 read fPRGGRP write fPRGGRP;
    /// match CENS_PROG.RECREV [nvarchar 3 0 0]
    property RECREV: RawUTF8 index 3 read fRECREV write fRECREV;
    /// match CENS_PROG.RECRVI [int 0 10 0]
    property RECRVI: Int64 read fRECRVI write fRECRVI;
    /// match CENS_PROG.FINFL1 [nvarchar 3 0 0]
    property FINFL1: RawUTF8 index 3 read fFINFL1 write fFINFL1;
    /// match CENS_PROG.FINFL2 [nvarchar 3 0 0]
    property FINFL2: RawUTF8 index 3 read fFINFL2 write fFINFL2;
    /// match CENS_PROG.FINFL3 [nvarchar 3 0 0]
    property FINFL3: RawUTF8 index 3 read fFINFL3 write fFINFL3;
    /// match CENS_PROG.FINFL4 [nvarchar 3 0 0]
    property FINFL4: RawUTF8 index 3 read fFINFL4 write fFINFL4;
    /// match CENS_PROG.FINFL5 [nvarchar 3 0 0]
    property FINFL5: RawUTF8 index 3 read fFINFL5 write fFINFL5;
    /// match CENS_PROG.RECEXP [date]
    property RECEXP: TDateTime read fRECEXP write fRECEXP;
    /// match CENS_PROG.RECTM1 [nvarchar 3 0 0]
    property RECTM1: RawUTF8 index 3 read fRECTM1 write fRECTM1;
  end;
...
begin
  ...
  if not UserCreated then begin
    fClient := TMongoClient.Create('rootcode.info',27017);
...
begin
  fMongoClient := TMongoClient.Create('rootcode.info',27017);
  ...
  fModel := TSQLModel.Create([TSQLORM,TSQLCENS_PROG]);
  ...
  Check(StaticMongoDBRegister(TSQLCENS_PROG,fClient.Server,fDB,'CENS_PROG')<>nil);

  //fModel.Props[TSQLCENS_PROG].ExternalDB.MapField('ID','PRGRUN');
  fClient.Server.CreateMissingTables;
  (fClient.Server.StaticDataServer[TSQLORM] as TSQLRestStorageMongoDB).Drop;
  (fClient.Server.StaticDataServer[TSQLCENS_PROG] as TSQLRestStorageMongoDB).Drop;
